...
public class FindIfTheStringMatchesPatren {

	public static void main(String[] args) {
		System.out.println(isMatch("redblue", "ab"));
	}
	...
	static boolean isMatch(String str, int i, String pat, int j,
		...
		if (map.containsKey(c)) {
			...
			if (i + s.length() > str.length()
					|| !str.substring(i, i + s.length()).equals(s)) {
				return false;
			}
