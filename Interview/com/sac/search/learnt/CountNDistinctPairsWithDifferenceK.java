 ...
 * ALGO=====================
 *
 * Find all the elements in array that sums up to diffrence.
 * 
 * Simpl maths a+b=sum; hence if a+b exists in array then its fine.
 * 
 * loop through all the elements and find the element in array whose valuse is
 * a[i]+k, using binary search where K is diff
 *
 *
 */
