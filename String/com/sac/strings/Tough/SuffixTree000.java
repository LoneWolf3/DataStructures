...

{
...

	{
...

		{
			...
			System.out.printf("%5d %5d %3d %5d %6d   ", s.start_node, s.end_node,
					Nodes[s.end_node].suffix_node, s.first_char_index, s.last_char_index);
...

	{
		...
		SuffixTree000 st = new SuffixTree000();
